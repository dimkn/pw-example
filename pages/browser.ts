...
export class BrowserPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.requestInputField = this.page.locator("//input[@id='search_form_input']")
  }

  public async searchFor(query: string) {
    await this.requestInputField.fill(query)

    this.searchResults = await this.page.locator("//article[@data-testid='result']/div[2]//div/a").all();
  }
